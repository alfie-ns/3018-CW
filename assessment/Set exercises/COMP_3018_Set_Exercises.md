...
In regards to HRI, this suggests that robots interacting with users across different social strata must modulate behaviours accordingly: deferential language and posture when addressing elders or authority figures, and a more directive interaction style when assisting in contexts where the robot is perceived as an institutional representative (Cirasa and Conti, 2025, p.7). Failing to encode these hierarchical norms risks contravening deeply held social expectations, thereby undermining trust.
